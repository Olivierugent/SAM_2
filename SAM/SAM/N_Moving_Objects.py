...
if av.PDPg_fundamental == 1:
    ...
    if av.N_PDP == 1:
        try:
            ...
            print("⚠️ N_PDP not found in SAM folder")
    ...
    if av.N_VA_HClust == 1:
        try:
            ...
            print("⚠️ N_VA_HClust not found in SAM folder")
    
    if av.N_VA_Mds == 1:
        try:
            import N_VA_Mds
        except ImportError:
            print("⚠️ N_VA_Mds not found in SAM folder")

    if av.N_VA_TopK == 1:
        try:
            import N_VA_TopK
        except ImportError:
            print("⚠️ N_VA_TopK not found in SAM folder")
